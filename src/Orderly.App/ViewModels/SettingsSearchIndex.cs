...
public sealed class SettingsSearchIndex : ISettingsSearchIndex
{
    ...
    private static readonly IReadOnlyList<SettingsSearchEntry> StaticEntries = new[]
    {
        ...
        new SettingsSearchEntry("悬浮球", "控制桌面悬浮入口球是否启用", new[] { "悬浮球", "悬浮窗", "浮窗", "入口" }, "外观与启动", "Chk_FloatingBallEnabled"),
        new SettingsSearchEntry("启动时显示悬浮球", "应用启动后自动呼出桌面悬浮球", new[] { "悬浮球", "悬浮窗", "浮窗", "启动" }, "外观与启动", "Chk_ShowFloatingWindow"),
